...
course_to_update = input("Enter course name to update: ")
new_score = float(input("Enter new score: "))
while new_score < 0 or new_score > 100:
    new_score = float(input("Score must be between 0 and 100. Enter new score: "))
if course_to_update in student['courses']:
    old_score = student['courses'][course_to_update]
    student['courses'][course_to_update] = new_score
    print(f"Updated {course_to_update} from {old_score} to {new_score}")
else:
    print("Course not found")
